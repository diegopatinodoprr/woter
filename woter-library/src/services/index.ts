...
export type {
  ...
  IBddCreateObjectResponse,
  IBddCreateObjectsRequest,
  IBddCreateObjectsResponse,
  IBddSearchObjectRequest,
  IBddSearchObjectResponse,
  IBddSearchObjectsRequest,
  IBddSearchObjectsResponse,
  IBddUpdateObjectRequest,
  IBddUpdateObjectResponse,
  IBddUpdateObjectsRequest,
  IBddUpdateObjectsResponse,
  IBddDeleteObjectRequest,
