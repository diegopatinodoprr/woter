...
import { UserAdminListviewComponent } from './listview/user-admin-listview.component';
import { UserAdminFormeditComponent } from './formedit/user-admin-formedit.component';
import { UserAdminFormnewComponent } from './formnew/user-admin-formnew.component';
...
@Component({
  ...
  imports: [CommonModule, UserAdminListviewComponent, UserAdminFormeditComponent, UserAdminFormnewComponent],
...
export class UserAdminModuleComponent implements OnInit {
  protected readonly moduleKey = 'userAdmin';
