...
@Component({
  selector: 'app-water-item-listview',
  imports: [CommonModule, ButtonModule, TableModule],
  templateUrl: './water-item-listview.component.html',
  styleUrl: './water-item-listview.component.css'
})
export class WaterItemListviewComponent {
  @Input() title = '';
